...
___
### **Distribution of Minority Population in USA by Race**
##### This chart displays the distribution of the United States' minority populations by race between 1980 and 2020. The Black and African American American Indian and Alaska Native populations remained relatively stable over time, while the other minority populations skyrocketed. The group two or more races increased the most dramatically, one of the reasons for this being that two or more races wasn't an option on the US Census before 2000. It's interesting to see the changes in demographics in our country throughout the years, especially because many of the minority populations are increasing. This has serious implications for considering the way our country is run, and what systematic obstacles are in the way of these growing minority populations. Data from [Wikipedia](https://en.wikipedia.org/wiki/Demographics_of_the_United_States).
